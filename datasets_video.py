...
def return_somethingv1(ROOT_DATASET):
    ...
    root_data = ROOT_DATASET + 'somethingv1/20bn-something-something-v1' #注意与你直接输入的root目录不同了！！！
    #存放数据集的目录结构应该是：root_path==>somethingv1::
                                                #train.txt,valid.txt,category.txt
...
def return_somethingv2(ROOT_DATASET):
    ...
    root_data = ROOT_DATASET + 'somethingv2/20bn-something-something-v2'
