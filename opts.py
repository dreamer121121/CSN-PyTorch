...
# ========================= Model Configs ==========================
parser.add_argument('--type', type=str, default="CSN",choices=['GST','R3D','S3D','CSN'],
                    help = 'type of temporal models, currently support GST,Res3D and S3D')
parser.add_argument('--backbone','--bk', type=str, default="resnet50",choices=['resnet50','resnet101'],
                    help = 'backbone networks, currently only support resnet')
parser.add_argument('--num_segments', type=int, default=8)
parser.add_argument('--mode',type=str,default='ir',help='choose the model mode presented in papaer ip or ir')
...
parser.add_argument('--gpus',default='0',type=str,help='choose gpus for training')
